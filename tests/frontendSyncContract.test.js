...
assert.match(index, /Versão 10\.1/);
assert.ok(index.indexOf("sync-confirmation.js") < index.indexOf("crm-ranking.js?v=10.1-crm-ranking-edit-r1"));
assert.ok(index.indexOf("crm-ranking.js?v=10.1-crm-ranking-edit-r1") < index.indexOf("app.js?v=10.1-crm-ranking-edit-r1"));
