...
assert.match(index, /Versão 10\.2/);
assert.ok(index.indexOf("sync-confirmation.js") < index.indexOf("crm-ranking.js?v=10.2-searchable-opportunity-r1"));
assert.ok(index.indexOf("crm-ranking.js?v=10.2-searchable-opportunity-r1") < index.indexOf("app.js?v=10.2-searchable-opportunity-r1"));
