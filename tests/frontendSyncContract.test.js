...
assert.ok(index.indexOf("sync-confirmation.js") < index.indexOf("crm-ranking.js?v=10.2-searchable-opportunity-r2"));
assert.ok(index.indexOf("crm-ranking.js?v=10.2-searchable-opportunity-r2") < index.indexOf("app.js?v=10.2-searchable-opportunity-r2"));
